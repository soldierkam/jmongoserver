 ...
 */
package org.kamionowski.jmongoserver.db.admin;
...
import org.kamionowski.jmongoserver.db.admin.cmd.*;
...
public class CommandCollection implements Collection {
    ...
    public CommandCollection(Database db) {
        ...
        register(new IsMasterCmd(this));
        register(new CountCmd(this));
        register(new DropDbCmd(this));
    }
